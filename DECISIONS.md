...
- לא ויתרתי על אף אחת מהמשימות שהוגדרו. אם היה לי עוד יום, הייתי משקיעה בשני כיוונים: לשפר את ה-UI כך שייראה יותר מקצועי ומטופל (עיצוב, מרווחים, feedback ויזואלי), והייתי ממשיכה לעבור על הפרויקט בעיניים של אבטחה כדי לוודא שלא נשארו עוד בעיות מעבר ל-SQL Injection שכבר טופל.
